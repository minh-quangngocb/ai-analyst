---
name: run-pipeline
description: "End-to-end analysis from business question to validated slide deck with DAG-based execution."
disable-model-invocation: true
argument-hint: "data_path=<path> question="<question>" [plan=full_presentation|deep_dive|quick_chart]"
---
# Run Pipeline
...
**Archive hook:**
1. Apply archive-analysis skill (`.github/skills/archive-analysis/SKILL.md`)
