...
## Skills Used
- `.github/skills/metric-spec/SKILL.md` — for defining primary, secondary, and guardrail metrics with full specifications
- `.github/skills/guardrails/SKILL.md` — for selecting guardrail metrics that pair with the primary success metric
- `.github/skills/triangulation/SKILL.md` — for sanity-checking baseline metrics and power estimation inputs
