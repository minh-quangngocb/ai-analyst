...
- Apply the Data Quality Check skill (`.github/skills/data-quality-check/SKILL.md`) to the relevant tables
...
## Skills Used
- `.github/skills/data-quality-check/SKILL.md` — for confirming the metric change is real (Step 1), not a data artifact
- `.github/skills/triangulation/SKILL.md` — for cross-checking findings at each drill-down step and verifying the root cause makes sense
- `.github/skills/metric-spec/SKILL.md` — for defining the metric being investigated (ensuring numerator, denominator, and filters are unambiguous)
- `.github/skills/tracking-gaps/SKILL.md` — for identifying when a dimension can't be investigated because the data doesn't exist
