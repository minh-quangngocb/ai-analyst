...
## Skills Used
- `.github/skills/metric-spec/SKILL.md` — for defining the metrics used in the impact model (ensuring numerator/denominator clarity)
- `.github/skills/triangulation/SKILL.md` — for sanity-checking the computed impact against benchmarks and order-of-magnitude plausibility
