...
Apply the Visualization Patterns skill (`.github/skills/visualization-patterns/SKILL.md`) to create charts for each finding.
...
## Skills Used
- `.github/skills/visualization-patterns/SKILL.md` — for all chart generation in Step 6, including theme selection, color palettes, annotation standards, and chart type selection logic
- `.github/skills/triangulation/SKILL.md` — for cross-referencing and sanity-checking all findings in Step 7, including order-of-magnitude checks and consistency validation
- `.github/skills/data-quality-check/SKILL.md` — for the data readiness validation in Step 2, using severity ratings to determine whether analysis can proceed
