...
Read `.github/skills/question-framing/SKILL.md`. Verify that:
...
## Skills Used
- `.github/skills/question-framing/SKILL.md` — to verify the narrative answers the original business question and follows the Question Ladder structure (goal, decision, metric, hypothesis)
