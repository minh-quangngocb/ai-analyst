...
Read `.github/skills/visualization-patterns/SKILL.md`. Load the theme specified by {{THEME}}. Extract:
...
## Skills Used
- `.github/skills/visualization-patterns/SKILL.md` — for theme selection (color palettes, typography, grid styling, annotation standards), chart type selection logic, and chart-specific formatting rules
