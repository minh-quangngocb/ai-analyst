...
Load `.github/skills/stakeholder-communication/SKILL.md`. Match {{AUDIENCE}} to the matrix:
...
## Skills Used
- `.github/skills/stakeholder-communication/SKILL.md` — audience matrix for tone calibration
