...
For each of the top 3 questions, apply the Tracking Gap Identification skill (`.github/skills/tracking-gaps/SKILL.md`):
...
- `.github/skills/tracking-gaps/SKILL.md` — for identifying data gaps and suggesting workarounds when needed data doesn't exist
